 ...
 */
Level.Five.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.Five.prototype.init = function() {
...
Level.Five.prototype.play = function(timeDiff) {
	// console.log("Level.Five.prototype.play" + timeDiff);
 ...
 */
Level.Five.prototype._generateBrick = function() {
 ...
 */
Level.Five.prototype._generateAnimation = function() {
	var anm = null;
...
// */
//Level.Five.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.Five.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.Five.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.Five.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.Five.prototype.lost = function() {
 ...
 */
Level.Five.prototype._handleBallLoss = function() {
 ...
 */
Level.Five.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Five.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Five.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.Five.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
 ...
 */
Level.Five.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.Five.prototype.pause = function() {
 ...
 */
Level.Five.prototype._drawAnimatation = function() {
