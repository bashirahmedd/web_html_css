...
Level.Six = function(stage) {
	...
	this.className="Level.Six";
	//this.bgClassName = "Game.Animation.LevelBG.One";
 ...
 */
Level.Six.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.Six.prototype.init = function() {
...
Level.Six.prototype.play = function(timeDiff) {
	// console.log("Level.Six.prototype.play" + timeDiff);
 ...
 */
Level.Six.prototype._generateBrick = function() {
 ...
 */
Level.Six.prototype._generateAnimation = function() {
...
// */
//Level.Six.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.Six.prototype._checkGameCompletion = function() {
...
// */
//Level.Six.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.Six.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.Six.prototype.lost = function() {
 ...
 */
Level.Six.prototype._handleBallLoss = function() {
 ...
 */
Level.Six.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Six.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Six.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.Six.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1.5, brickHeight * 2, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 3 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0.5, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1.5, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2.5, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));		
	/* row 4 */
 ...
 */
Level.Six.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.Six.prototype.pause = function() {
 ...
 */
Level.Six.prototype._drawAnimatation = function() {
