...
Level.FourDotOne = function(stage) {
	this.stage = stage;
	...
	this.className="Level.FourDotOne";
 ...
 */
Level.FourDotOne.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.FourDotOne.prototype.init = function() {
...
Level.FourDotOne.prototype.play = function(timeDiff) {
	// console.log("Level.FourDotOne.prototype.play" + timeDiff);
 ...
 */
Level.FourDotOne.prototype._generateBrick = function() {
 ...
 */
Level.FourDotOne.prototype._generateAnimation = function() {
...
// */
//Level.FourDotOne.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.FourDotOne.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.FourDotOne.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.FourDotOne.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.FourDotOne.prototype.lost = function() {
 ...
 */
Level.FourDotOne.prototype._handleBallLoss = function() {
 ...
 */
Level.FourDotOne.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotOne.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotOne.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.FourDotOne.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
 ...
 */
Level.FourDotOne.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.FourDotOne.prototype.pause = function() {
 ...
 */
Level.FourDotOne.prototype._drawAnimatation = function() {
