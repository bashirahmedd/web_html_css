...
Level.OneDotThree = function(stage) {
	this.stage = stage;
	...
	this.className="Level.OneDotThree";
 ...
 */
Level.OneDotThree.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.OneDotThree.prototype.init = function() {
	...
	/**
	 * nextLevel gives reference to the next level, played after this level nextFunc implements LevelOneDotOne
...
Level.OneDotThree.prototype.play = function(timeDiff) {
	// console.log("Level.OneDotThree.prototype.play" + timeDiff);
 ...
 */
Level.OneDotThree.prototype._generateBrick = function() {
 ...
 */
Level.OneDotThree.prototype._generateAnimation = function() {

	var anm = null;
	anm = new Game.Animation.One(this.stage);
	anm.init();
...
// */
//Level.OneDotThree.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.OneDotThree.prototype._checkGameCompletion = function() {
...
// */
//Level.OneDotThree.prototype._clearBrickOnCollision = function(brickIndex) {
//	if (this.brickContainer[brickIndex].hitCount == 0) { // brick hit strength is not yet 0
 ...
 * with a brick
 */
Level.OneDotThree.prototype._multiCollistionCorrection = function(brickIndex) {
...
/*************************************************************************************************************
 * public method ball die, continue to reply the levelone or exit/reset the game
 */

Level.OneDotThree.prototype.lost = function() {
 ...
 */
Level.OneDotThree.prototype._handleBallLoss = function() {
 ...
 * gameball die, continue to reply the levelone or exit/reset the game
 */
Level.OneDotThree.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotThree.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotThree.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.OneDotThree.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	var brickTotalWidth = 62; // border and filled area
	var brickHeight = gs.game.breakerBall.DEFAULTRADIUS * 2;

	/* row 0 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 1, brickHeight, 60, 1, "#48036F", 2, 30));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 2, brickHeight, 60, 1, "#48036F", 2, 30));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 3, brickHeight, 60, 1, "#48036F", 2, 30));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 3 */
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 4, brickHeight, 60, 1, "#48036F", 2, 30));
	/* row 4 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 5, brickHeight, 60, 1, "#A65200", 1, 20));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 6, brickHeight, 60, 1, "#A65200", 1, 20));
	...
	/* row 6 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 7, brickHeight, 60, 1, "#A65200", 1, 20));
	...
	/* row 7 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 8, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 8, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 8, brickHeight, 60, 1, "#A65200", 1, 20));
	/* row 8 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 9, brickHeight, 60, 1, "#48036F", 2, 30));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 10, brickHeight, 60, 1, "#48036F", 2, 30));
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 11, brickHeight, 60, 1, "#48036F", 2, 30));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 11 */
	...
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 12, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 12, brickHeight, 60, 1, "#48036F", 2, 30));
	/* row 12 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 13, brickHeight, 60, 1, "#A65200", 1, 20));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 13 */
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 14, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 14, brickHeight, 60, 1, "#A65200", 1, 20));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 14, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 14, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 14*/
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 15, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 15, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 15, brickHeight, 60, 1, "#A65200", 1, 20));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 15, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 15*/
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 0, brickHeight * 16, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 1, brickHeight * 16, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 2, brickHeight * 16, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick (wallXoffset + brickTotalWidth * 3, brickHeight * 16, brickHeight, 60, 1, "#A65200", 1, 20));
 ...
 */
Level.OneDotThree.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.OneDotThree.prototype.pause = function() {
 ...
 */
Level.OneDotThree.prototype._drawAnimatation = function() {
