...
Level.FiveDotTwo = function(stage) {
	this.stage = stage;
	...
	this.className="Level.FiveDotTwo";
 ...
 */
Level.FiveDotTwo.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.FiveDotTwo.prototype.init = function() {
...
Level.FiveDotTwo.prototype.play = function(timeDiff) {
	// console.log("Level.FiveDotTwo.prototype.play" + timeDiff);
 ...
 */
Level.FiveDotTwo.prototype._generateBrick = function() {
 ...
 */
Level.FiveDotTwo.prototype._generateAnimation = function() {
	var anm = null;
	anm = new Game.Animation.Five(this.stage);
	anm.init();
...
// */
//Level.FiveDotTwo.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.FiveDotTwo.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.FiveDotTwo.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.FiveDotTwo.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.FiveDotTwo.prototype.lost = function() {
 ...
 */
Level.FiveDotTwo.prototype._handleBallLoss = function() {
 ...
 */
Level.FiveDotTwo.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FiveDotTwo.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FiveDotTwo.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.FiveDotTwo.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	var brickTotalWidth = 62; // border and filled area
	var brickHeight = gs.game.breakerBall.DEFAULTRADIUS * 2;
	/* row 0 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0, brickHeight * 0, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2, brickHeight * 0, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 1 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.25, brickHeight * 1, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.25, brickHeight * 1, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 2 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.5, brickHeight * 2, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.5, brickHeight * 2, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 3 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.75, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.75, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 4 */
	...
	/* row 5 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.25, brickHeight * 5, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 6 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.50,  brickHeight * 6, brickHeight, 60, 1,  "#A65200", 1, 20));
	/* row 6 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.75, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 7 */
	...
	/* row 8 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.25, brickHeight * 9, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.25, brickHeight * 9, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 9 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.5, brickHeight * 10, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.5, brickHeight * 10, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 10 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.75, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.75, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 11 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1, brickHeight * 12, brickHeight, 60, 1, "#A65200", 1, 20));
...
//	/* row 13 */
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.5, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
//	/* row 14 */
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1, brickHeight * 14, brickHeight, 60, 1, "#FF0000", 0, 10));
//	/* row 15*/
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 15, brickHeight, 60, 1, "#FF0000", 0, 10));
//	/* row 16*/
...
//	/* row 17*/
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.5, brickHeight * 17, brickHeight, 60, 1, "#FF0000", 0, 10));
//	/* row 18*/
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0,  brickHeight * 18, brickHeight, 60, 1,  "#A65200", 1, 20));
//	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 3, brickHeight * 18, brickHeight, 60, 1, "#FF0000", 0, 10));
};

/*************************************************************************************************************
 * public method destroys object like bricks array after lost and won state of the level
 */
Level.FiveDotTwo.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.FiveDotTwo.prototype.pause = function() {
 ...
 */
Level.FiveDotTwo.prototype._drawAnimatation = function() {
