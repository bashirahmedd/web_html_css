 ...
 */
Level.Four.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.Four.prototype.init = function() {
...
Level.Four.prototype.play = function(timeDiff) {
	// console.log("Level.Four.prototype.play" + timeDiff);
 ...
 */
Level.Four.prototype._generateBrick = function() {
 ...
 */
Level.Four.prototype._generateAnimation = function() {
	var anm = null;
	anm = new Game.Animation.Four(this.stage);
	anm.init();
...
// */
//Level.Four.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.Four.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.Four.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.Four.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.Four.prototype.lost = function() {
 ...
 */
Level.Four.prototype._handleBallLoss = function() {
 ...
 */
Level.Four.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Four.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Four.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.Four.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, 0, brickHeight, 60, 1, "#A65200", 1, 20));
	...
	/* row 5 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 5, brickHeight, 60, 1, "#A65200", 1, 20));
};

/*************************************************************************************************************
 * public method destroys object like bricks array after lost and won state of the level
 */
Level.Four.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.Four.prototype.pause = function() {
 ...
 */
Level.Four.prototype._drawAnimatation = function() {
