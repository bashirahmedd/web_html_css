...
Level.FiveDotOne = function(stage) {
	this.stage = stage;
	...
	this.className="Level.FiveDotOne";
 ...
 */
Level.FiveDotOne.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.FiveDotOne.prototype.init = function() {
...
Level.FiveDotOne.prototype.play = function(timeDiff) {
	// console.log("Level.FiveDotOne.prototype.play" + timeDiff);
 ...
 */
Level.FiveDotOne.prototype._draw = function() {
	gs.game.paintConroller.clearAll();
 ...
 */
Level.FiveDotOne.prototype._generateBrick = function() {
 ...
 */
Level.FiveDotOne.prototype._generateAnimation = function() {
	var anm = null;
...
// */
//Level.FiveDotOne.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.FiveDotOne.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.FiveDotOne.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.FiveDotOne.prototype._multiCollistionCorrection = function(brickIndex) {
 ...
 * private method
 */
Level.FiveDotOne.prototype._updateTile = function() {
	var tileX = gs.game.defenderTile.x;
	var mousePos = this.stage.getMousePos();
	if (mousePos !== null) {
		/*
		 * stop to move beyond the right boundary
		 */
		if (mousePos.x + gs.game.defenderTile.width < this.stage.width) {
			tileX = mousePos.x;
		}
	}
...
Level.FiveDotOne.prototype.lost = function() {
 ...
 */
Level.FiveDotOne.prototype._handleBallLoss = function() {
 ...
 */
Level.FiveDotOne.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FiveDotOne.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FiveDotOne.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.FiveDotOne.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 3, 0, brickHeight, 60, 1, "#48036F", 2, 30));
	/* row 1 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.5, brickHeight * 1, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 2 */
	...
	/* row 3 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 4 */
	...
	/* row 5 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.5, brickHeight * 5, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 6 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0,  brickHeight * 6, brickHeight, 60, 1,  "#A65200", 1, 20));
	...
	/* row 7 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2.5, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 8 */
	...
	/* row 9 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 9, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 10 */
	...
	/* row 11 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0.5, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 12 */
 ...
 */
Level.FiveDotOne.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.FiveDotOne.prototype.pause = function() {
 ...
 */
Level.FiveDotOne.prototype._drawAnimatation = function() {
