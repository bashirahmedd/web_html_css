...
Level.FourDotThree = function(stage) {
	this.stage = stage;
	...
	this.className="Level.FourDotThree";
 ...
 */
Level.FourDotThree.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.FourDotThree.prototype.init = function() {
	...
	/**
	 * nextLevel gives reference to the next level, played after this level nextFunc implements LevelOne
...
Level.FourDotThree.prototype.play = function(timeDiff) {
	// console.log("Level.FourDotThree.prototype.play" + timeDiff);
 ...
 */
Level.FourDotThree.prototype._generateBrick = function() {
 ...
 */
Level.FourDotThree.prototype._generateAnimation = function() {
	// console.log("Level.Two.prototype._generateAnimation");
	var anm = null;
	anm = new Game.Animation.Three(this.stage);
	anm.init();
...
// */
//Level.FourDotThree.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.FourDotThree.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.FourDotThree.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.FourDotThree.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.FourDotThree.prototype.lost = function() {
 ...
 */
Level.FourDotThree.prototype._handleBallLoss = function() {
 ...
 */
Level.FourDotThree.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotThree.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotThree.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.FourDotThree.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	var brickTotalWidth = 62; // border and filled area
	var brickHeight = gs.game.breakerBall.DEFAULTRADIUS * 2;

	/* row 0 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 0, 0, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, 0, brickHeight, 60, 1, "#48036F", 2, 30));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 3, 0, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 1 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 1, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 2 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 2, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 2, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 3 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2, brickHeight * 3, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 4 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 5 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 5, brickHeight, 60, 1, "#48036F", 2, 30));	
	/* row 6 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 6, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 7 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 7, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 8 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 8, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 8, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 9 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 9, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 10 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 10, brickHeight, 60, 1, "#48036F", 2, 30));		
	/* row 11 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 2, brickHeight * 11, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 12*/
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 12, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 12, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 3, brickHeight * 12, brickHeight, 60, 1, "#FF0000", 0, 10));
	/* row 13 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 13, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	/* row 14 */
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth, brickHeight * 14, brickHeight, 60, 1, "#FF0000", 0, 10));
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 15, brickHeight, 60, 1, "#000000", 3, 40));
 ...
 */
Level.FourDotThree.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.FourDotThree.prototype.pause = function() {
 ...
 */
Level.FourDotThree.prototype._drawAnimatation = function() {
