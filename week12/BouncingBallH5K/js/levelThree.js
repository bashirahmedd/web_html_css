 ...
 */
Level.Three.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.Three.prototype.init = function() {
	...
	/**
	 * nextLevel gives reference to the next level, played after this level nextFunc implements LevelThree
...
Level.Three.prototype.play = function(timeDiff) {
	// console.log("Level.Three.prototype.play" + timeDiff);
 ...
 */
Level.Three.prototype._generateBrick = function() {
 ...
 */
Level.Three.prototype._generateAnimation = function() {
	var anm = null;
...
// */
//Level.Three.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.Three.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.Three.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.Three.prototype._multiCollistionCorrection = function(brickIndex) {
...
/*************************************************************************************************************
 * public method ball die, continue to reply the levelThree or exit/reset the game
 */

Level.Three.prototype.lost = function() {
 ...
 */
Level.Three.prototype._handleBallLoss = function() {
...
/*************************************************************************************************************
 * public method all the bricks destroyed, congratulate the player continue to level Three or exit/reset the
 * gameball die, continue to reply the levelThree or exit/reset the game
 */
Level.Three.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Three.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.Three.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.Three.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
 ...
 */
Level.Three.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.Three.prototype.pause = function() {
 ...
 */
Level.Three.prototype._drawAnimatation = function() {
