...
Level.OneDotTwo = function(stage) {
	this.stage = stage;
	...
	this.className="Level.OneDotTwo";
 ...
 */
Level.OneDotTwo.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.OneDotTwo.prototype.init = function() {
...
Level.OneDotTwo.prototype.play = function(timeDiff) {
	// console.log("Level.OneDotTwo.prototype.play" + timeDiff);
 ...
 */
Level.OneDotTwo.prototype._generateBrick = function() {
 ...
 */
Level.OneDotTwo.prototype._generateAnimation = function() {
...
// */
//Level.OneDotTwo.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.OneDotTwo.prototype._checkGameCompletion = function() {
...
// */
//Level.OneDotTwo.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.OneDotTwo.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.OneDotTwo.prototype.lost = function() {
 ...
 */
Level.OneDotTwo.prototype._handleBallLoss = function() {
 ...
 */
Level.OneDotTwo.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotTwo.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotTwo.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.OneDotTwo.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
 ...
 */
Level.OneDotTwo.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.OneDotTwo.prototype.pause = function() {
 ...
 */
Level.OneDotTwo.prototype._drawAnimatation = function() {
