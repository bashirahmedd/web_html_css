...
Level.OneDotOne = function(stage) {
	this.stage = stage;
	this.canvas = this.stage.getCanvas();
	this.context = this.stage.getContext();
	this.container = this.stage.getContainer();
	this.nextFunc = "init";
	this.levelName = "Level 1.1";
	this.className="Level.OneDotOne";
 ...
 */
Level.OneDotOne.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.OneDotOne.prototype.init = function() {
...
Level.OneDotOne.prototype.play = function(timeDiff) {
	// console.log("Level.OneDotOne.prototype.play" + timeDiff);
 ...
 */
Level.OneDotOne.prototype._generateBrick = function() {
 ...
 */
Level.OneDotOne.prototype._generateAnimation = function() {
...
// */
//Level.OneDotOne.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.OneDotOne.prototype._checkGameCompletion = function() {
...
// */
//Level.OneDotOne.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.OneDotOne.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.OneDotOne.prototype.lost = function() {
 ...
 */
Level.OneDotOne.prototype._handleBallLoss = function() {
 ...
 */
Level.OneDotOne.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotOne.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.OneDotOne.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.OneDotOne.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
 ...
 */
Level.OneDotOne.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.OneDotOne.prototype.pause = function() {
 ...
 */
Level.OneDotOne.prototype._drawAnimatation = function() {
