...
Level.FourDotTwo = function(stage) {
	this.stage = stage;
	this.canvas = this.stage.getCanvas();
	this.context = this.stage.getContext();
	this.container = this.stage.getContainer();
	this.nextFunc = "init";
	this.levelName = "Level 4.2";
	this.className="Level.FourDotTwo";
 ...
 */
Level.FourDotTwo.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.FourDotTwo.prototype.init = function() {
...
Level.FourDotTwo.prototype.play = function(timeDiff) {
	// console.log("Level.FourDotTwo.prototype.play" + timeDiff);
 ...
 */
Level.FourDotTwo.prototype._generateBrick = function() {
 ...
 */
Level.FourDotTwo.prototype._generateAnimation = function() {
...
// */
//Level.FourDotTwo.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.FourDotTwo.prototype._checkGameCompletion = function() {
...
// * private method
// */
//Level.FourDotTwo.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.FourDotTwo.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.FourDotTwo.prototype.lost = function() {
 ...
 */
Level.FourDotTwo.prototype._handleBallLoss = function() {
 ...
 */
Level.FourDotTwo.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotTwo.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.FourDotTwo.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.FourDotTwo.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, 0, brickHeight, 60, 1, "#000000", 3, 40));
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 1.5, brickHeight * 10, brickHeight, 60, 1, "#000000", 3, 40));
 ...
 */
Level.FourDotTwo.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.FourDotTwo.prototype.pause = function() {
 ...
 */
Level.FourDotTwo.prototype._drawAnimatation = function() {
