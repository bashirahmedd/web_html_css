 ...
 */
Level.One.prototype.load = function() {
	this.nextFunc = "play";
};
 ...
 * 
 */
Level.One.prototype.init = function() {
	...
	//console.log("brick count: "+ this.brickContainer.length);
};

Level.One.prototype.play = function(timeDiff) {
 ...
 */
Level.One.prototype._generateBrick = function() {
 ...
 */
Level.One.prototype._generateAnimation = function() {
...
// */
//Level.One.prototype._drawBrick = function() {
//	var allBroken = true;
...
// * private method
// */
//Level.One.prototype._checkGameCompletion = function() {
...
// */
//Level.One.prototype._clearBrickOnCollision = function(brickIndex) {
 ...
 * with a brick
 */
Level.One.prototype._multiCollistionCorrection = function(brickIndex) {
...
Level.One.prototype.lost = function() {
 ...
 */
Level.One.prototype._handleBallLoss = function() {
 ...
 */
Level.One.prototype.won = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.One.prototype.gameOver = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
 ...
 * public method
 */
Level.One.prototype.gameCompleted = function() {
	this._destroyLevelObjects(); // destroy the previous level objects
	gs.currentGameState = gs.gameState.playLevel;
	gs.game.levelController.currentLevelIndex = 0;
	var level = gs.game.levelController.getLevel(gs.game.levelController.currentLevelIndex);
 ...
 */
Level.One.prototype._loadBrickTemplate = function() {
	var wallXoffset = 36;
	...
	this._brickTemplate.push(new Game.Material.Brick(wallXoffset + brickTotalWidth * 3, brickHeight * 4, brickHeight, 60, 1, "#FF0000", 0, 10));
 ...
 */
Level.One.prototype._destroyLevelObjects = function() {
 ...
 * public method pause
 */
Level.One.prototype.pause = function() {
 ...
 */
Level.One.prototype._drawAnimatation = function() {
